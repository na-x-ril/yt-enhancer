...
* Animated view counter with odometer-style transitions
* Automatic video looping
* Persistent preferred video quality
* Automatic subtitle activation
* Playback resume from last watched position
* DVR availability indicator for live streams
...
await storageBridge.set('quality_reference', 'hd1080');
```
...
| -------------------- | ------ | ----------------------- |
| dropdown_config      | object | Feature toggle state    |
| quality_reference    | string | Preferred video quality |
| video_time_{videoId} | number | Last playback position  |
...
2. Create a side branch (`feature/<name>`)
